...
<div class='ij-body'>
    <div class='container'>
        <div class="form-group col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-4">
            ...
            echo form_dropdown('idcategory', $dropdown_options, false, $dropdown_data);
            echo "</div>";
